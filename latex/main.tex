...
\begin{itemize}
  \item Amino acids and their precursors (e.g., glycine detected toward a solar-type protostar; see~\cite{Rivilla2025}, a preprint whose DOI resolves to first author Quan rather than Rivilla---citation metadata may change upon formal publication)
...
\textbf{Reading note:} ``Very Low'' prior does not mean ``impossible''---it means the claim requires substantially more evidence than currently available before it can compete with simpler explanations.
